...
├── packages/ui/       @innate/ui — Shared UI components (shadcn)
├── packages/core/     @innate/core — Business logic + Platform Bridge
├── packages/views/    @innate/views — Shared page views
